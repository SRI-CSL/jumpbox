...
class Stegotorus(Resource):
   ...
   delay = 1
   stegotorus = 'http://127.0.0.1:6543/stegotorus/ss_push'
   cycle = 0
...
class Pull(Resource):
   ...
   def render_GET(self, request):
      ...
      #need to set DJB-URI and DJB-METHOD at least
      request.setHeader('DJB-Method', 'POST');
      request.setHeader('DJB-SeqNo', Stegotorus.cycle);
      request.setHeader('DJB-URI', Stegotorus.stegotorus);
   ...
   def make_clientCookie(self, request):
      ...
      request.setHeader('DJB-Cookie', cookie)
